...
var reservedKeywords = {
  ...
  // 'SET',
  'SOME', // 'STRUCT',
  'TABLE', 'TABLESAMPLE SYSTEM', 'THEN', 'TO', 'TREAT', 'TRUE', 'UNBOUNDED', // 'UNION',
  'UNNEST', // 'USING',
  // 'WHEN',
  // 'WHERE',
  // 'WINDOW',
...
'SELECT', 'FROM', 'WHERE', 'GROUP BY', 'HAVING', 'ORDER BY', 'QUALIFY', 'WINDOW', 'PARTITION BY', 'LIMIT', 'OFFSET', 'WITH', 'OMIT RECORD IF', // legacy
// DML, https://cloud.google.com/bigquery/docs/reference/standard-sql/dml-syntax
'INSERT', 'INSERT INTO', 'VALUES', 'DELETE', 'DELETE FROM', 'TRUNCATE TABLE', 'UPDATE', 'MERGE', 'MERGE INTO', // 'USING',
